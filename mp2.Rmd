...
```
      ...
      This next pipeline simply ffilter the previous data frame so only the two major parties are shown in the graphic. This pipeline also omitted any candidate who had no available data. 
```{r, message=FALSE, warning=FALSE}
